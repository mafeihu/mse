...
<div class="content">
	<!-----------------------------------------内容开始--------------------------------------------------->
	<div class="infoBox">
		<form name="form" action="/Admin/Base/inne_course" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" value="<?php echo ($a["id"]); ?>">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" id="basic">
				<tr bgcolor="white">
					<td class="" bgcolor="white">内训课:</td>
					<td colspan="2">
						<textarea id="content" name="content" style="width:80%;height:480px;"><?php echo ($a["inne_course"]); ?> </textarea>
					</td>
				</tr>
