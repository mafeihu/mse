...
function edit(id){
	location.href="/mse/Admin/User/edit/id/"+id;
}
//进入到下级
function xj(id){
	location.href="/mse/Admin/User/index2/id/"+id;
}
function getnums(){
    var num = $("#nus").val();
    var start = $("#start").val();
    ...
    window.location.href="/mse/Admin/User/index?nums="+num+"&start="+start+"&end="+end+"&username="+username;
}
function sendname() {
    var num = $("#nus").val();
    var start = $("#start").val();
...
<div class="tools">
    <?php if($pagetitle == 直播会员列表): ?><div class="add"><span><a href="/mse/Admin/User/toadd">添加</a></span></div><?php endif; ?>
