...
function getnums(){
    ...
    window.location.href="/mse/Admin/Caiwu/give_gift_list?nums="+num+"&start="+start+"&end="+end+"&username="+username+"&status="+status;
}
function sendname() {
    var num = $("#nus").val();
    var status = $("#status").val();
...
<div class="tools" style="text-align:center">
    <span style="padding-top:10px;">统计送礼钻石:&nbsp;&nbsp;<?php echo ((isset($sum) && ($sum !== ""))?($sum):0); ?>&nbsp;&nbsp;钻石</span>
</span>
