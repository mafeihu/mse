...
.Prompt_top, .Prompt_btm, .Prompt_ok, .Prompt_x { background:url(/mse/Public/admin/images/message.gif) no-repeat; display:inline-block }
    ...
    <dl>
      ...
      <dd>
        ...
        <?php if(!isset($closeWin)): ?><p>系统将在 <span style="color:blue;font-weight:bold" id="second"><?php echo ($waitSecond); ?></span> 秒后自动跳转,如果不想等待,直接点击 <A HREF="<?php echo ($jumpUrl); ?>"><font color="red">这里</font></A> 跳转<br/>
            或者 <a href="/mse/">返回首页</a></p><?php endif; ?>
      </dd>
    </dl>
    <div class="c"></div>
    </div>
